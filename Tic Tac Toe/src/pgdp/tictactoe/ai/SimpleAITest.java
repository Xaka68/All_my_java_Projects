...
public class SimpleAITest {
	...
	class AIcouldWin {
		...
		void basicExampleOne() {
			Field[][] board = { { new Field(6, true), null, new Field(5, true) },
					{ new Field(3, false), new Field(5, false), null }, { null, null, null } };
			SimpleAI ai = new SimpleAI();
		...
		void basicExampleTwo() {
			...
			assertTrue((move.x() == 0 && move.y() == 1) || (move.x() == 1 && move.y() == 2)
					|| (move.x() == 1 && move.y() == 1 && move.value() > 5));
			assertFalse(firstPlayedPieces[move.value()]);
		}
	}
	...
	class OpponentCouldWin {
		...
		@DisplayName("Example #1")
		void basicExampleOne() {
			Field[][] board = { { new Field(6, true), null, new Field(5, true) }, { new Field(3, false), null, null },
					{ null, null, null } };
			SimpleAI ai = new SimpleAI();
			boolean[] firstPlayedPieces = { false, false, false, false, false, true, true, false, false };
