...
public class GameTests {
	 ...
	 * 
	 * 
	 * TEST CASES: - einfacher sieg in zeile - einfacher sieg in spalte - einfacher
	 * sieg in diagonale (beide diagonalen) - direkt verloren illegaler zug (x
	 * koord, y koord, value out of bounds, value schon genutzt, eigener stein dort,
	 * höherer gegner stein dort) - sieg nach überdecken fremder stein (test nur für
	 * zeile) - unentschieden - kann nicht mehr legen - sieg mit letztem stein
	 * 
	 */
	...
	public static Move[] parseString(String s) {
		...
		for (int i = 0; i < split.length; i += 3) {
			moves[i / 3] = new Move(Integer.parseInt(split[i + 1]), Integer.parseInt(split[i + 2]),
