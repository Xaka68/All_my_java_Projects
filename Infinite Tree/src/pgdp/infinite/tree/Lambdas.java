...
public class Lambdas {
	...
	/**
	 * @name Count up/down
	 * @description Generates tree with child [parent + 1] or [parent - 1] depending
	 *              on the parents sign. Node with value 0 has children -1 and 1.
	 */
	 ...
	 */
	public static final Function<String[], Iterator<String[]>> makeHeavyChildren = S -> List
			.of(new String[S.length * 2], new String[S.length * 3]).iterator();
