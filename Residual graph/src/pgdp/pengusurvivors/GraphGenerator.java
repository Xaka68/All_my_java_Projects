...
public class GraphGenerator {
	...
	/*
	 * Returns a flow graph parsed from the given string. The string must be
	 * formatted as follows: a -> b (1/1); a -> c (2/0); b -> c; c -> d (3/0); This
	 * would imply the following graph: a / \ b - c | d A edge is defined as
	 * following: <identifier> -> <identifier> [(<number>/<number>)]. The first
	 * number is the flow, the second number is the capacity. The flow is optional
	 * and defaults to 0. The capacity is optional and defaults to 1.
	 */
