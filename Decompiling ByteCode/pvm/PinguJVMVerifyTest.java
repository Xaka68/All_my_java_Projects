...
public class PinguJVMVerifyTest {
	...
	void shouldThrowPVMErrorForInsufficientArithmeticStackSize() {
		Stream<String> invalid = Stream.of("ALLOC 2", "CONST 0", "STORE 0", "CONST 1", "STORE 1", "LOAD 0", "ADD");
	...
	void shouldThrowPVMErrorForInsufficientBooleanStackSize() {
		Stream<String> invalid = Stream.of("ALLOC 2", "TRUE", "STORE 0", "FALSE", "STORE 1", "LOAD 0", "AND");
	...
	void shouldThrowPVMErrorForInsufficientComparisonStackSize() {
		Stream<String> invalid = Stream.of("ALLOC 2", "CONST 1", "STORE 0", "CONST 2", "STORE 1", "LOAD 0", "EQ");
	...
	void shouldThrowPVMErrorWhenNegatingBooleanWithNEG() {
		Stream<String> invalid = Stream.of("ALLOC 1", "TRUE", "STORE 0", "LOAD 0", "NEG");
	...
	void shouldThrowPVMErrorForInsufficientArithmeticNegationStackSize() {
		Stream<String> invalid = Stream.of("ALLOC 1", "CONST 1", "STORE 0", "NEG");
	...
	void shouldThrowPVMErrorForInsufficientBooleanNegationStackSize() {
		Stream<String> invalid = Stream.of("ALLOC 1", "CONST 1", "STORE 0", "NOT");
	...
	void shouldThrowPVMErrorWhenNegatingIntWithNOT() {
		Stream<String> invalid = Stream.of("ALLOC 2", "CONST 3", "STORE 0", "LOAD 0", "NOT");
	...
	void shouldThrowPVMErrorForIncompatibleArithmeticTypes() {
		Stream<String> invalid = Stream.of("ALLOC 2", "TRUE", "STORE 0", "CONST 3", "STORE 1", "LOAD 0", "LOAD 1",
				"ADD");
	...
	void shouldThrowPVMErrorWhenWritingBoolean() {
		Stream<String> invalid = Stream.of("ALLOC 1", "TRUE", "STORE 0", "LOAD 0", "WRITE");
	...
	@Test
	// cannot test for message here because there is no preset PVMError for this
	// situation
	void shouldThrowPVMErrorWhenLoadingFromNegativeAddress() {
		Stream<String> invalid = Stream.of("ALLOC 1", "CONST 4", "STORE 0", "LOAD -3");
	...
	void shouldThrowPVMErrorWhenLoadingFromOOBAddress() {
		Stream<String> invalid = Stream.of("ALLOC 1", "CONST 4", "STORE 0", "LOAD 1");
	...
	void shouldThrowPVMErrorWhenLoadingUndefined() { // shouldn't be possible according to the docs
		Stream<String> invalid = Stream.of("ALLOC 2", "CONST 1", "STORE 0", "LOAD 1");
	...
	void shouldThrowPVMErrorWhenStoringToNegativeAddress() {
		Stream<String> invalid = Stream.of("ALLOC 1", "CONST 4", "STORE -3");
	...
	void shouldThrowPVMErrorWhenStoringToOOBAddress() {
		Stream<String> invalid = Stream.of("ALLOC 1", "CONST 4", "STORE 1");
	...
	void shouldThrowPVMErrorWhenPOPStackSizeInsufficient() {
		Stream<String> invalid = Stream.of("ALLOC 1", "CONST 1", "STORE 0", "POP");
	...
	void shouldThrowPVMErrorWhenDUPStackSizeInsufficient() {
		Stream<String> invalid = Stream.of("ALLOC 1", "CONST 1", "STORE 0", "DUP");
	...
	void shouldThrowPVMErrorWhenFJUMPStackSizeInsufficient() {
		Stream<String> invalid = Stream.of("ALLOC 1", "CONST 1", "STORE 0", "FJUMP here", "here:", "HALT");
	...
	void shouldThrowPVMErrorWhenFJUMPNotBoolean() {
		Stream<String> invalid = Stream.of("ALLOC 1", "CONST 1", "STORE 0", "LOAD 0", "FJUMP here", "here:", "HALT");
