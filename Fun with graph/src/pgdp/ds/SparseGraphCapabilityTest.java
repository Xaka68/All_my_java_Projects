...
class SparseGraphCapabilityTest {
	/**
	 * Laut Aufgabenstellung muss der Sparse Graph "mehrere Millionen" Knoten, aber
	 * "nur einige wenige Kanten pro Knoten speichern können. Hier können Graphen
	 * generiert werden, mit nodes Knoten und edgesPerNode Kanten pro Knoten.
	 * Constraints: nodes > 1000, edgesPerNode < nodes
	 **/

	private int nodes = 5000;
	private int edgesPerNode = 4;
