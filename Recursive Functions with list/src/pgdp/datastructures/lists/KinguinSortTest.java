...
public class KinguinSortTest extends TestBase {
	...
	static Stream<Arguments> testKinguinSortSingleElementList() {
		return Stream.of(arguments(list(0), list(0), true), arguments(list(0), list(0), false));
	}
	...
	static Stream<Arguments> testKinguinSortDoubleElementList() {
		return Stream.of(arguments(list(0, 1), list(0, 1), true), arguments(list(0), list(0, 1), false));
	}
	...
	static Stream<Arguments> testKinguinSortEmptyList() {
		return Stream.of(arguments(list(), list(), true), arguments(list(), list(), false));
	}
	...
	static Stream<Arguments> testKinguinSortIntegerBorderElements() {
		return Stream.of(arguments(list(Integer.MAX_VALUE), list(Integer.MAX_VALUE, 0, Integer.MIN_VALUE), true),
				arguments(list(Integer.MAX_VALUE, 0, Integer.MIN_VALUE), list(Integer.MAX_VALUE, 0, Integer.MIN_VALUE),
						false));
	}
	...
	static Stream<Arguments> testKinguinSort() {
		return Stream.of(arguments(list(3, 4, 7, 9), list(3, 2, 4, 7, 1, 6, 5, 9, 8), true),
				arguments(list(3, 2, 1), list(3, 2, 4, 7, 1, 6, 5, 9, 8), false),
				arguments(list(-5, 0, 5), list(-5, 0, 5), true), arguments(list(-5), list(-5, 0, 5), false));
	}
}
