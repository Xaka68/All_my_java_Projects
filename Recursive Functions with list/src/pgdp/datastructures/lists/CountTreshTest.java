...
import static pgdp.datastructures.lists.TestBase.list;
...
public class CountTreshTest {
	...
	static Stream<Arguments> testCountThreshSingleElement() {
		return Stream.of(arguments(list(2), 1, new long[] { 0, 0, 2 }), arguments(list(2), 2, new long[] { 0, 2, 0 }),
	...
	// Edge Case 4
	// Auszug aus Artemis:
	// "Die Methode kann auf jeder möglichen Liste aufgerufen werden, aber es kommt
	// in unseren Tests nicht zu long-Overflows."
	...
	static Stream<Arguments> testCountThreshProvokingIntegerOverUnderflow() {
		return Stream.of(
				arguments(list(Integer.MAX_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE), Integer.MAX_VALUE,
						new long[] { 0, Integer.MAX_VALUE * 3L, 0 }),
				arguments(list(1, 2, 3, Integer.MAX_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE), Integer.MAX_VALUE,
						new long[] { 6, Integer.MAX_VALUE * 3L, 0 }),
				arguments(list(Integer.MIN_VALUE, Integer.MIN_VALUE, Integer.MIN_VALUE), Integer.MIN_VALUE,
						new long[] { 0, Integer.MIN_VALUE * 3L, 0 }),
				arguments(list(1, 2, 3, Integer.MIN_VALUE, Integer.MIN_VALUE, Integer.MIN_VALUE), Integer.MIN_VALUE,
						new long[] { 0, Integer.MIN_VALUE * 3L, 6 }));
	}
	...
	static Stream<Arguments> testCountThresh() {
		return Stream.of(arguments(list(1, 2, 3, 4, 5), 3, new long[] { 3, 3, 9 }),
