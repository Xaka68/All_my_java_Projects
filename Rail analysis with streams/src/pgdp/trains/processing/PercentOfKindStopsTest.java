...
public class PercentOfKindStopsTest {
	...
	final List<TrainConnection> exampleTrainConnections = List.of(
			new TrainConnection("ICE 2", "ICE", "2", "DB",
					List.of(new TrainStop(Station.MUENCHEN_HBF, LocalDateTime.of(2022, 12, 1, 11, 0),
							LocalDateTime.of(2022, 12, 1, 11, 0), TrainStop.Kind.REGULAR),
							new TrainStop(Station.NUERNBERG_HBF, LocalDateTime.of(2022, 12, 1, 11, 30),
									LocalDateTime.of(2022, 12, 1, 12, 0), TrainStop.Kind.REGULAR))),
			new TrainConnection("ICE 1", "ICE", "1", "DB",
					List.of(new TrainStop(Station.MUENCHEN_HBF, LocalDateTime.of(2022, 12, 1, 10, 0),
							...
							new TrainStop(Station.NUERNBERG_HBF, LocalDateTime.of(2022, 12, 1, 10, 30),
									LocalDateTime.of(2022, 12, 1, 10, 30), TrainStop.Kind.REGULAR))),
			new TrainConnection("ICE 3", "ICE", "3", "DB",
					List.of(new TrainStop(Station.MUENCHEN_HBF, LocalDateTime.of(2022, 12, 1, 12, 0),
							LocalDateTime.of(2022, 12, 1, 12, 0), TrainStop.Kind.REGULAR),
							new TrainStop(Station.AUGSBURG_HBF, LocalDateTime.of(2022, 12, 1, 12, 20),
									LocalDateTime.of(2022, 12, 1, 13, 0), TrainStop.Kind.CANCELLED),
							new TrainStop(Station.NUERNBERG_HBF, LocalDateTime.of(2022, 12, 1, 13, 30),
									LocalDateTime.of(2022, 12, 1, 13, 30), TrainStop.Kind.REGULAR))));
	...
	void testExampleCancelled() {
		...
		double actual = DataProcessing.percentOfKindStops(trainConnections, TrainStop.Kind.CANCELLED);
	...
	void testExampleRegular() {
		...
		double actual = DataProcessing.percentOfKindStops(trainConnections, TrainStop.Kind.REGULAR);
	...
	void testExampleAdditional() {
		...
		double exepcted = 0.0;
		double actual = DataProcessing.percentOfKindStops(trainConnections, TrainStop.Kind.ADDITIONAL);
	...
	void testAdditionalAllStops() {
		...
		double actual = DataProcessing.percentOfKindStops(trainConnections.stream(), TrainStop.Kind.ADDITIONAL);
	...
	void testCancelledAllStops() {
		...
		double exepcted = 100.0;
		double actual = DataProcessing.percentOfKindStops(trainConnections.stream(), TrainStop.Kind.CANCELLED);
	...
	void testRegularAllStops() {
		...
		double exepcted = 100.0;
		double actual = DataProcessing.percentOfKindStops(trainConnections.stream(), TrainStop.Kind.REGULAR);
	...
	void testRegularEmptyStops() {
		...
		// Source:
		// https://zulip.in.tum.de/#narrow/stream/1504-PGdP-W09H02/topic/.E2.9C.94.20percentKindofStops.28.29.20Prozent/near/860094
		double exepcted = 0.0;
		double actual = DataProcessing.percentOfKindStops(trainConnections.stream(), TrainStop.Kind.REGULAR);
	...
	private List<TrainConnection> trainConnectionsWithOnly(TrainStop.Kind kind) {
		return List.of(
				new TrainConnection("ICE 1", "ICE", "1", "DB",
						List.of(new TrainStop(Station.MUENCHEN_HBF, LocalDateTime.of(2022, 12, 1, 10, 0),
								LocalDateTime.of(2022, 12, 1, 10, 0), kind),
								new TrainStop(Station.NUERNBERG_HBF, LocalDateTime.of(2022, 12, 1, 10, 30),
										LocalDateTime.of(2022, 12, 1, 10, 30), kind))),
				new TrainConnection("ICE 2", "ICE", "2", "DB",
						List.of(new TrainStop(Station.MUENCHEN_HBF, LocalDateTime.of(2022, 12, 1, 11, 0),
								LocalDateTime.of(2022, 12, 1, 11, 0), kind),
								new TrainStop(Station.NUERNBERG_HBF, LocalDateTime.of(2022, 12, 1, 11, 30),
										LocalDateTime.of(2022, 12, 1, 12, 0), kind))),
				new TrainConnection("ICE 3", "ICE", "3", "DB",
						List.of(new TrainStop(Station.MUENCHEN_HBF, LocalDateTime.of(2022, 12, 1, 12, 0),
								LocalDateTime.of(2022, 12, 1, 12, 0), kind),
								new TrainStop(Station.AUGSBURG_HBF, LocalDateTime.of(2022, 12, 1, 12, 20),
										LocalDateTime.of(2022, 12, 1, 13, 0), kind),
								new TrainStop(Station.NUERNBERG_HBF, LocalDateTime.of(2022, 12, 1, 13, 30),
										LocalDateTime.of(2022, 12, 1, 13, 30), kind))));
	}
}
