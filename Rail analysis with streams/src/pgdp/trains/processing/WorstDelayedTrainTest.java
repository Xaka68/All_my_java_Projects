	...
	void testMultipleTrainsWithSameWorstDelay() {
		...
		List<TrainConnection> trainConnections = List.of(
				...
				new TrainConnection("ICE 3", "ICE", "3", "DB",
						List.of(new TrainStop(Station.MUENCHEN_HBF, LocalDateTime.of(2022, 12, 1, 12, 0),
								LocalDateTime.of(2022, 12, 1, 12, 0), TrainStop.Kind.REGULAR),
								new TrainStop(Station.NUERNBERG_HBF, LocalDateTime.of(2022, 12, 1, 12, 30),
										LocalDateTime.of(2022, 12, 1, 13, 0), TrainStop.Kind.REGULAR))));

		TrainConnection worstDelayedTrain = DataProcessing.worstDelayedTrain(trainConnections.stream());

		// Tests if worstDelayedTrain is one of the trains with the worst delay.
		assertTrue(
				worstDelayedTrain.equals(trainConnections.get(1)) || worstDelayedTrain.equals(trainConnections.get(2)));
	}
		...
		List<TrainConnection> trainConnections = List.of(
				...
				new TrainConnection("ICE 2", "ICE", "2", "DB",
						List.of(new TrainStop(Station.MUENCHEN_HBF, LocalDateTime.of(2022, 12, 1, 11, 0),
								LocalDateTime.of(2022, 12, 1, 11, 0), TrainStop.Kind.REGULAR),
								new TrainStop(Station.NUERNBERG_HBF, LocalDateTime.of(2022, 12, 1, 11, 30),
										LocalDateTime.of(2022, 12, 1, 11, 30), TrainStop.Kind.REGULAR))),
				new TrainConnection("ICE 3", "ICE", "3", "DB",
						List.of(new TrainStop(Station.MUENCHEN_HBF, LocalDateTime.of(2022, 12, 1, 12, 0),
								LocalDateTime.of(2022, 12, 1, 12, 0), TrainStop.Kind.REGULAR),
								new TrainStop(Station.NUERNBERG_HBF, LocalDateTime.of(2022, 12, 1, 12, 30),
										LocalDateTime.of(2022, 12, 1, 12, 30), TrainStop.Kind.REGULAR))));
